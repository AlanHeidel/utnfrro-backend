...
import { canTransitionPedidoState } from "./pedido-state.rules.js";
...
export class PedidoService {
  ...
  async updateEstado(id: number, estado: PedidoEstado) {
    ...
    if (!canTransitionPedidoState(pedido.estado, estado)) {
      throw new Error("pedido state is terminal and cannot be changed");
    }
